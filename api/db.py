...
def make_pool() -> AsyncConnectionPool:
    ...
    Taille, délai et préparation des requêtes sont configurables : les valeurs qui
    conviennent à un process long-vivant sont fausses en serverless derrière un pooler
    (cf. `api/config.py`).
    """
